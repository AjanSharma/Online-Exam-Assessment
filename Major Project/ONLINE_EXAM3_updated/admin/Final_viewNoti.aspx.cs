...
public partial class viewNoti : System.Web.UI.Page
{
    ...
    private void showBlog()
    {
        ...
        string q = "select * from Final_Noti";
        DataTable dt = new DataTable();http://localhost:51526/ONLINE_EXAM3_updated/admin/Final_viewNoti.aspx.cs
    ...
    {
        string query = "update Final_Noti set estatus='" + desc + "' where eid='" + id + "'";
    ...
    {
        string str = "delete from Final_Noti where eid='" + id + "'";
