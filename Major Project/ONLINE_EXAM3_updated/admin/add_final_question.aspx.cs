    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            if (TextBox2.Text.Equals(string.Empty) || TextBox3.Text.Equals(string.Empty) || TextBox4.Text.Equals(string.Empty) || TextBox5.Text.Equals(string.Empty) || TextBox6.Text.Equals(string.Empty) || TextBox7.Text.Equals(string.Empty))
            {
                ...
                if (Request.QueryString["DB_Name"].Equals("Final_Question"))
                {
                    con.open_connection();
                    string str = "insert into Final_Question values('" + txtQID.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + txtSubject.Text + "','"+cmb_level.SelectedValue+"')";
                    SqlCommand cmd = new SqlCommand(str, con.con_pass());
                    cmd.ExecuteNonQuery();
                    con.close_connection();
