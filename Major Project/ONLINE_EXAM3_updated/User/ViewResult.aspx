<%@ Page Title="" Language="C#" MasterPageFile="~/User/Student.master" AutoEventWireup="true" CodeFile="ViewResult.aspx.cs" Inherits="ViewResult" %>
...
<h2>View Marks </h2>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT sname, SUM(rans) AS Expr2 FROM Exam1 GROUP BY sname">
         <SelectParameters>
...
<div>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="rans" HeaderText="Correct Answer" SortExpression="rans" />
        </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ConnectionString="<%$ ConnectionStrings:APIIT %>" 
        SelectCommand="SELECT [sname], [uans], [dbans], [ttime], [rans] FROM [Exam1]">
        <SelectParameters>
            <asp:SessionParameter Name="username" SessionField="emailID" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
