<%@ Page Title="" Language="C#" MasterPageFile="~/User/Student.master" AutoEventWireup="true" CodeFile="viewPractise.aspx.cs" Inherits="User_viewPractise" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <center>
<h1>Student View Practise Test Marks</h1>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:APIIT %>" 
         SelectCommand="SELECT sname, SUM(rans) AS Expr2 FROM Exam1  WHERE ([username] = @username) GROUP BY sname">
         <SelectParameters>
