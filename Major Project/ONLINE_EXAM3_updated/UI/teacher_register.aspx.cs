    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        if (txtFname.Text == "" || txtLName.Text == "" || txtFather.Text == "" || txtEmail.Text == "" || txtPass.Text == "" || txtcPass.Text == "" || txtPone.Text == "" || txtPostal.Text == "")
        {
            ...
            try
            {
                ...
                string str = "insert into registration values('" + txtID.Text + "','" + txtEmail.Text + "','" + txtFname.Text + "','" + txtLName.Text + "','" + DropDownList1.SelectedItem.Text + "','" + txtFather.Text + "','" + txtPass.Text + "','" + dob + "','" + txtAdd.Text + "','" + txtCity.Text + "','" + txtState.Text + "','" + txtPostal.Text + "','" + txtCountry.Text + "','" + txtPone.Text + "','" + System.DateTime.Now.ToString() + "','" + Image1.ImageUrl + "','" + utype + "','"+txtSubject.Text+"')";
                SqlCommand cmd = new SqlCommand(str, con.con_pass());
                cmd.ExecuteNonQuery();
