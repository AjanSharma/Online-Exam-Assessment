<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Home.master" AutoEventWireup="true" CodeFile="teacher_register.aspx.cs" Inherits="register" %>
        ...
        <td align="right" height="25">
         ...
         <tr>
            ...
            &nbsp;<asp:TextBox ID="TextBox1" runat="server"  Width="145" Height="30"  ReadOnly="false" onclick="showCal(this, event)"></asp:TextBox>
               ...
               <td align="right"  >
                   <asp:Label ID="Label11" runat="server" Text="Subject " ForeColor="Black"></asp:Label>
                    &nbsp;</td>
                    <td>
                        <asp:TextBox ID="txtSubject" runat="server" Width="145" Height="30"></asp:TextBox>
                        &nbsp;</td>
